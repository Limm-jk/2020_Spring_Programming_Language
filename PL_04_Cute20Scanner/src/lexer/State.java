	...
	START {
		...
		public TransitionOutput transit(ScanContext context) {
			...
			switch ( ch.type() ) {
				...
				case SPECIAL_CHAR: //special charactorÍ∞? ?ì§?ñ¥?ò® Í≤ΩÏö∞ 
					if ( ) { //Î∂??ò∏?ù∏Í≤ΩÏö∞ ?ÉÅ?ÉúÎ∞òÌôò
						
					}
					else if (  ) {  //boolean?ù∏ Í≤ΩÏö∞ ?ÉÅ?ÉúÎ∞òÌôò
						
					}
					else { //Í∑∏Ïô∏?óê?äî type?ùÑ ?ïå?ïÑ?Ç¥?Ñú ?ïåÎßûÏ? ?ÉÅ?ÉúÎ°? Î∞òÌôò
